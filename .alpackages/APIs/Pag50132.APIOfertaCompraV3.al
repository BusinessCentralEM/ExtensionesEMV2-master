page 50132 APIOfertaCompraV3
{
    APIGroup = 'Master';
    APIPublisher = 'EM';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'apiOfertaCompraV3';
    DelayedInsert = true;
    EntityName = 'apiOfertaCompraV3';
    EntitySetName = 'apiOfertaCompraV3';
    PageType = API;
    ...
    begin
        ...
        REC.SETRANGE(CorreoEnviadoGerente, FALSE);
        REC.SetRange(ActividadActual, rec.ActividadActual::Negociacion);
